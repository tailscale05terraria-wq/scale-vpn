...
class _MainVpnScreenState extends State<MainVpnScreen> with SingleTickerProviderStateMixin {
  ...
  // Итоговое число узлов, вставляемых в список за один поиск, выбирается
  // случайно в диапазоне [_minCollectedNodes; _maxCollectedNodes], чтобы не
  // грузить в приложение сразу все сотни ключей из источника.
  ...
  Future<void> _performSearchAttempt(int attempt) async {
    ...
    // Случайная цель по количеству узлов на этот заход поиска: 10-15.
